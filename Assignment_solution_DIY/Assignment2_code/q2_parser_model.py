...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        ### YOUR CODE HERE
        """
        注意，带self.的是类属性，不带的是tf中的节点名，由placeholder()中name=参数指定
        """
    ...
    def add_prediction_op(self):
        ...
        with tf.variable_scope('partial_parser'):
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        sum_loss = tf.nn.softmax_cross_entropy_with_logits_v2(labels=self.labels_placeholder,logits=pred)
